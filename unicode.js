...
let numCode1 = inputString2.charCodeAt(0);
let numCode2 = inputString2.charCodeAt(5);
let swappedString = String.fromCharCode(numCode2) + inputString2.charAt(1)  + inputString2.charAt(2) + inputString2.charAt(3) + inputString2.charAt(4) + String.fromCharCode(numCode1)// Your code here
